...
public:
    ...
    Sphere(float radius = 1.0f, int sectorCount = 36, int stackCount = 18, glm::vec3 amb = glm::vec3(0.941f, 0.937f, 0.714f), glm::vec3 diff = glm::vec3(0.941f, 0.937f, 0.714f), glm::vec3 spec = glm::vec3(0.941f, 0.937f, 0.714f), float shiny = 32.0f) : verticesStride(24)
    {
